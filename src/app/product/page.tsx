...
const page = (): React.ReactElement => {
  ...
  return (
    <main className="container flex h-fit min-h-screen flex-col items-center justify-center gap-4 bg-primary pt-[calc(var(--navbar-height)-2em)] md:pt-0">
      {isSuccess ? (
        <section className="grid min-h-screen items-center justify-center gap-4 md:grid-cols-2">
          <div className="flex h-[50vh] w-full items-center justify-center bg-product-svg bg-contain bg-center bg-no-repeat md:h-[75vh]">
